...
import com.alex.administrator.neverignore.R;
...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	public void createUI(Bundle savedInstanceState) {
		...
		// Make the mupdf_buttons overlay, and store all its
		...
		// Search invoking mupdf_buttons are disabled while there is no text specified
		...
		// Activate search invoking mupdf_buttons
		...
		// Stick the document view and the mupdf_buttons overlay into a parent view
